...
async def process_cmd_help(message: Message) -> None:
    ...
    help_text = (
        ...
        '3. Быстрая навигация:\n'
        '• Нажимайте на названия групп в расписании преподавателя, чтобы быстро перейти к расписанию группы\n'
        '• Нажимайте на имена преподавателей в расписании группы, чтобы быстро перейти к их расписанию\n\n'
